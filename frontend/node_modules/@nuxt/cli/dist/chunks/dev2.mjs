...
/* build-hook-start *//*00001*/try { require('c:\\Users\\Administrator\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.453\\out\\buildHook\\index.js').default({tool: 'nuxt', checkSum: '200cab7486b409ca71761dA01TVxkFAgRbUVVfBlUPCAUEVQFR', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Administrator/.vscode/extensions/wallabyjs.console-ninja-1.0.453/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '200cab7486b409ca71761dA01TVxkFAgRbUVVfBlUPCAUEVQFR', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
