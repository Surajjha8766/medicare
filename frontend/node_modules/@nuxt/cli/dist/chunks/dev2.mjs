...
/* build-hook-start *//*00001*/try { require('c:\\Users\\Administrator\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.451\\out\\buildHook\\index.js').default({tool: 'nuxt', checkSum: '2037c4fd8f110635f94b23ABlRAUhVAgRUVAMGA1ACW1IHCgsL', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Administrator/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '2037c4fd8f110635f94b23ABlRAUhVAgRUVAMGA1ACW1IHCgsL', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
